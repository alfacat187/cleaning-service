...
async def seed_roles_and_permissions() -> None:
    ...
    editor_role.permissions.extend(
        [read_permission, write_permission, customer, cleaner]
    )
    user_role.permissions.extend([read_permission, modify_permission])
    user_customer_role.permissions.extend(
        [read_permission, modify_permission, customer]
    )
